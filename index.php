...
<head>
	<title>ADIVINADOR-GRUPO-1</title>
...
if ($resultado = mysqli_query($enlace, $consulta)) {
	...
	if($resultado->num_rows === 0)
    {
		...
		if($pregunta == 0){
			...
			echo "<a class='botonSI' href='respuesta.php?r=1&n=".$nodo."&p=".$texto."&np=".$proxPregunta."'>SÍ</a>";
			echo "<a class='botonNO' href='respuesta.php?r=0&n=".$nodo."&p=".$texto."&np=".$proxPregunta."'>NO</a>";
			echo "</div>";
		...
		//SI ES UNA PREGUNTA, PREGUNTAMOS (SI DUDAMOS, EN EL PARÁMETRO "R" GUARDAMOS LA RAMA ALTERNATIVA, SINO VALE CERO)
			...
			echo "<a class='botonSI' href='index.php?n=".$nodoSi."&r=0&np=".$proxPregunta."'>SÍ</a>";
			echo "<a class='botonNO' href='index.php?n=".$nodoNo."&r=0&np=".$proxPregunta."'>NO</a>";
			echo "<a class='boton' href='index.php?n=".$nodoProbablementeSi."&r=".$nodoProbablementeNo."&np=".$proxPregunta."'>A LO MEJOR SI</a>";
			echo "<a class='boton' href='index.php?n=".$nodoProbablementeNo."&r=".$nodoProbablementeSi."&np=".$proxPregunta."'>QUIZAS NO</a>";
			echo "<a class='boton' href='index.php?n=".$nodoAleatorio."&r=".$nodoAleatorioAlt."&np=".$proxPregunta."'>NO ESTOY SEGURO</a>";
...
<?php
	echo "<a href='index.php?n=1&r=0'>Jugar de nuevo</a>";
?>
